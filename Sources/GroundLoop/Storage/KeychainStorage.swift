...
public final class KeychainStorage: AccountStorage, @unchecked Sendable {
    ...
    private let accountsKey = "groundloop.accounts"
    private let queue = DispatchQueue(label: "groundloop.keychain", qos: .userInitiated)
    
    public init(service: String = "com.groundloop.app") {
